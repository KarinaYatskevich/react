...
const Dialogs: React.FC<PropsType> = (props) => {
    ...
    let dialogsElement = state.dialogs.map( (d:any) => <DialogItem name={d.name} key={d.id} id={d.id}/>)
